 ...
 * PHP websocket客户端
 * By 老雷
 * 修改自swoole websocketClient
 */

$ws=new ws('127.0.0.1',9000);
$ws->connect();
$msg=json_encode([
	"msg"=>"hi ws Im php client",
]);
$ws->send($msg);
/**/
class ws
{
    ...
    {
		$msg=$this->hybi10Encode($data, $type, $masked);
		return socket_send($this->socket,$msg,strlen($msg),0);
    }
